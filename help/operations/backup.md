...
The Recovery Time Objective (RTO) depends on the size of the repository, but as a general guideline, the recovery sequence should take anywhere from 30 minutes to several hours.
